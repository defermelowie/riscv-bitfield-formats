...
pub fn to_csr(name: &str, value: u64) -> Result<Box<dyn Csr>, CsrError> {
    match &*name.to_lowercase() {
        ...
        "pte_sv32" => Ok(Box::new(Pte32::new(value))),
        "pte_sv39" => Ok(Box::new(Pte39::new(value))),
        "pte_sv48" => Ok(Box::new(Pte48::new(value))),
        "pte_sv57" => Ok(Box::new(Pte57::new(value))),
        "vaddr_sv32" => Ok(Box::new(VAddr32::new(value))),
        "vaddr_sv39" => Ok(Box::new(VAddr39::new(value))),
        "vaddr_sv48" => Ok(Box::new(VAddr48::new(value))),
        "vaddr_sv57" => Ok(Box::new(VAddr57::new(value))),
        "paddr_sv32" => Ok(Box::new(PAddr32::new(value))),
        "paddr_sv39" => Ok(Box::new(PAddr39::new(value))),
        "paddr_sv48" => Ok(Box::new(PAddr48::new(value))),
        "paddr_sv57" => Ok(Box::new(PAddr57::new(value))),
        // Unkown CSR
